                                ...
                                <tbody>
                                  ...
                                  ?>
                                  	<tr>
                                  		...
                                  		<td class="text-center"><img src="media/<?php echo $row['profile'] ?>" alt="" class="rounded-circle"></td>
                                      ...
                                      <td>
                                        <div class="dropdown">
                                          ...
                                          <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href= "all-teacher.php?teacher=1&delete_teacher=1&teacher_id=<?=$row['id'] ?>">Delete</a>
                                              <a class="dropdown-item" href= "update.php?teacher=1&update_teacher=1&teacher_id=<?=$row['id'] ?>"></i>Edit
                                              </a>
                                          </div>
                                        </div>
                                      </td>
         ...
         <div class="card-body">
             ...
             <div class="table-responsive">
                 <table class="table display data-table text-nowrap">
                     ...
                     <tbody>
                       <?php
                       $query = "SELECT * FROM teachers WHERE class = '$this_class'";
                       $select = mysqli_query($con, $query);
                       while ($row = mysqli_fetch_assoc($select)) {
                         $x = 1;
                       ?>
